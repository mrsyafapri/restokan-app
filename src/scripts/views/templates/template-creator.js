...
const createRestaurantDetailTemplate = (restaurant) => `
    <img class="detail__image" src="${API_ENDPOINT.IMG.S}${restaurant.pictureId}" alt="${restaurant.name}" class="detail__image" />
...
const createRestaurantItemTemplate = (restaurant) => `
    <div class="list_item">
        <img class="lazyload list_item_thumb" data-src="${API_ENDPOINT.IMG.S}${restaurant.pictureId}" alt="${restaurant.name}" />
